...
--
-- Name: master; Type: SCHEMA; Schema: -; Owner: tcc
--

CREATE SCHEMA master;


ALTER SCHEMA master OWNER TO tcc;
...
--
-- Name: basket_id_basket_seq; Type: SEQUENCE; Schema: master; Owner: tcc
--
...
ALTER TABLE basket_id_basket_seq OWNER TO tcc;
...
--
-- Name: basket; Type: TABLE; Schema: master; Owner: tcc
--
...
ALTER TABLE basket OWNER TO tcc;

--
-- Name: basket_item; Type: TABLE; Schema: master; Owner: tcc
--
...
ALTER TABLE basket_item OWNER TO tcc;

--
-- Name: client_id_client_seq; Type: SEQUENCE; Schema: master; Owner: tcc
--
...
ALTER TABLE client_id_client_seq OWNER TO tcc;

--
-- Name: client; Type: TABLE; Schema: master; Owner: tcc
--
...
ALTER TABLE client OWNER TO tcc;

--
-- Name: id_request_answer_seq; Type: SEQUENCE; Schema: master; Owner: tcc
--
...
ALTER TABLE id_request_answer_seq OWNER TO tcc;

--
-- Name: id_tuple_seq; Type: SEQUENCE; Schema: master; Owner: tcc
--
...
ALTER TABLE id_tuple_seq OWNER TO tcc;

--
-- Name: item_id_tem_seq; Type: SEQUENCE; Schema: master; Owner: tcc
--
...
ALTER TABLE item_id_tem_seq OWNER TO tcc;

--
-- Name: item; Type: TABLE; Schema: master; Owner: tcc
--
...
ALTER TABLE item OWNER TO tcc;

--
-- Name: request_answer; Type: TABLE; Schema: master; Owner: tcc
--
...
ALTER TABLE request_answer OWNER TO tcc;

--
-- Name: tuple; Type: TABLE; Schema: master; Owner: tcc
--
...
ALTER TABLE tuple OWNER TO tcc;

--
-- Data for Name: basket; Type: TABLE DATA; Schema: master; Owner: tcc
--
...
--
-- Name: basket_id_basket_seq; Type: SEQUENCE SET; Schema: master; Owner: tcc
--

SELECT pg_catalog.setval('basket_id_basket_seq', 56, true);


--
-- Data for Name: basket_item; Type: TABLE DATA; Schema: master; Owner: tcc
--
...
--
-- Data for Name: client; Type: TABLE DATA; Schema: master; Owner: tcc
--
...
--
-- Name: client_id_client_seq; Type: SEQUENCE SET; Schema: master; Owner: tcc
--
...
--
-- Name: id_request_answer_seq; Type: SEQUENCE SET; Schema: master; Owner: tcc
--

SELECT pg_catalog.setval('id_request_answer_seq', 2106, true);


--
-- Name: id_tuple_seq; Type: SEQUENCE SET; Schema: master; Owner: tcc
--

SELECT pg_catalog.setval('id_tuple_seq', 308, true);


--
-- Data for Name: item; Type: TABLE DATA; Schema: master; Owner: tcc
--
...
10	0.0129999999999999994	0.0170000000000000012	0	0.00200000000000000004	Fermento em pó		25016	0
...
13	0.0120000000000000002	0.0210000000000000013	0	0.00100000000000000002	Pão de Queijo		25027	0
...
17	0.0100000000000000002	0.0400000000000000008	0	0.00100000000000000002	Jogo de esfregões		83021	0
18	0.0120000000000000002	0.0299999999999999989	0.00600000000000000012	0.00200000000000000004	Limpa vidros		83020	0
19	0.100000000000000006	0.0420000000000000026	0.0229999999999999996	0.00400000000000000008	Prateleira suspensa		68013	0
20	0.0210000000000000013	0.0149999999999999994	0.00700000000000000015	0.00200000000000000004	Sabonete - II		10038	0
21	0.0219999999999999987	0.0420000000000000026	0	0.00100000000000000002	Rastelo		52002	0
...
24	0.0719999999999999946	0.0449999999999999983	0.0389999999999999999	0.0350000000000000033	Freezer 1 porta		68125_I	0
25	0.0650000000000000022	0.117999999999999994	0.0299999999999999989	0.0570000000000000021	Guarda roupa simples		68118	0
...
27	0.076999999999999999	0.0140000000000000003	0.0379999999999999991	0.00100000000000000002	Colchão p/ berço azul		14004_az	0
8	0.0160000000000000003	0.0250000000000000014	0.00400000000000000008	0.00100000000000000002	Farinha de trigo	sol	25010	0
28	0.0219999999999999987	0.0420000000000000026	0	0.00100000000000000002	Rastelo		52002	0
29	0	0.0299999999999999989	0	0.00300000000000000006	Barril em madeira	médio	81018md	0.0219999999999999987
\.


--
-- Name: item_id_tem_seq; Type: SEQUENCE SET; Schema: master; Owner: tcc
--
...
--
-- Data for Name: request_answer; Type: TABLE DATA; Schema: master; Owner: tcc
--
...
--
-- Data for Name: tuple; Type: TABLE DATA; Schema: master; Owner: tcc
--
...
--
-- Name: basket_item_pk; Type: CONSTRAINT; Schema: master; Owner: tcc
--
...
--
-- Name: basket_pk; Type: CONSTRAINT; Schema: master; Owner: tcc
--
...
--
-- Name: client_pk; Type: CONSTRAINT; Schema: master; Owner: tcc
--
...
--
-- Name: object_pk; Type: CONSTRAINT; Schema: master; Owner: tcc
--
...
--
-- Name: request_answer_pk; Type: CONSTRAINT; Schema: master; Owner: tcc
--
...
--
-- Name: tuple_pk; Type: CONSTRAINT; Schema: master; Owner: tcc
--
...
--
-- Name: idx_txt_alternative_id; Type: INDEX; Schema: master; Owner: tcc
--
...
--
-- Name: basket_basket_item_fk; Type: FK CONSTRAINT; Schema: master; Owner: tcc
--
...
--
-- Name: item_basket_item_fk; Type: FK CONSTRAINT; Schema: master; Owner: tcc
--
...
--
-- Name: tuple_request_answer_fk; Type: FK CONSTRAINT; Schema: master; Owner: tcc
--
...
--
-- Name: public; Type: ACL; Schema: -; Owner: tcc
--
